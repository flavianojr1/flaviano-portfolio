...
export const portfolio = {
  ...
  about: {
    ...
    en: {
      ...
      facts: [
        '2M+ records processed & reconciled',
  ...
  skillsData: [
    {
      ...
      topics: {
        ...
        en: [
          'Complex queries & advanced JOINs',
          'Temp Tables, CTEs & Query Indexing',
          'Query optimization & performance tuning',
          'Database auditing & data validation',
        ],
      },
    },
    {
    ...
    },
    {
      ...
      topics: {
        ...
        en: [
          ...
          'API & flat-file data integrations',
        ],
      },
    },
    {
      ...
      topics: {
        ...
        en: [
          'Large-scale reconciliation (2M+ records)',
          'Discrepancy detection & data integrity fixes',
          'Operational audit & compliance assurance',
    ...
    },
    {
      ...
      topics: {
        ...
        en: [
          ...
          'Dynamic formulas & pivot data analysis',
          'Macro routine automation via VBA',
          'Ad-hoc quantitative reporting',
        ],
      },
    },
    {
      ...
      topics: {
        ...
        en: [
          ...
          'AI prompt engineering & agent workflows',
          'Model Context Protocol (MCP)',
          'Agentic Coding (Antigravity, Claude Code & Cursor)',
        ],
      },
    },
  ],
  ...
  projectsData: [
    {
      title: {
        pt: 'JobTrackr · Portal de Vagas & Analytics',
        en: 'JobTrackr · Recruitment Analytics & Tracker',
      },
      ...
      result: {
        ...
        en: 'Automated application entry, pipeline traceability, and executive search KPIs',
      },
    ...
    {
      title: {
        pt: 'Portal Hub Financeiro',
        en: 'Financial Hub Analytics Platform',
      },
    ...
    {
      title: {
        pt: 'Análise de Custos de Veículos · Oficina',
        en: 'Fleet Maintenance & Cost Analytics',
      },
    ...
    {
      title: {
        pt: 'Detecção de Fraudes em Cartão',
    ...
    {
      title: {
        pt: 'Inadimplência por UF · Dados Bacen',
        en: 'Regional Loan Default Rate Analysis · Central Bank Data',
      },
    ...
    {
      title: {
        pt: 'Segmentação de Clientes · K-Means',
        en: 'Customer Segmentation · K-Means Clustering',
      },
  ...
  experienceData: [
    {
      ...
      highlights: {
        ...
        en: [
          'Development, cleaning, and validation of large-scale financial datasets for operational closing routines.',
          'Built SQL Server and Python pipelines for data consolidation, standardization, and multi-product enrichment.',
          'Optimized critical SQL Server queries and routines, reducing execution runtime from days to hours.',
          'Engineered automated reconciliation pipelines for 2M+ record datasets, identifying discrepancies and eliminating audit risks.',
          'Developed and refactored executive Power BI dashboards with advanced DAX modeling for managerial decision-making.',
        ],
      },
    },
    {
      ...
      role: {
        ...
        en: 'Business Analyst / Operations',
      },
      highlights: {
        pt: [
        ...
        en: [
          'Analyzed commercial, financial, and operational datasets to support dynamic pricing, cost control, and sales planning.',
          'Built end-to-end Power BI & Excel KPI frameworks, enabling data-driven pricing strategies that drove a 30% revenue increase.',
        ],
      },
    },
    {
      ...
      highlights: {
        ...
        en: [
          'Led end-to-end e-commerce operations, inventory control, cost modeling, and product pricing strategies in Excel.',
          'Managed e-commerce web platform development, digital catalog optimization, and multi-marketplace channel integrations.',
          'Coordinated order fulfillment, fiscal compliance, logistics workflows, and multi-channel sales KPI tracking.',
        ],
      },
    },
    {
      ...
      highlights: {
        ...
        en: [
          'Development and maintenance of responsive institutional web applications in PHP, MySQL, HTML, CSS, and WordPress.',
        ],
      },
    },
  ],
  ...
  educationData: [
    ...
    },
    {
      ...
      course: {
        ...
        en: "Technological Degree (B.Tech) in Financial Management",
      },
      period: '2021 — 2022',
    ...
    },
    {
      ...
      course: {
        ...
        en: 'Technical Diploma in Software Development & IT',
      },
      period: '2012 — 2014',
      status: { pt: 'Concluído', en: 'Completed' },
    },
  ...
  certificationsData: [
    ...
    {
      name: {
        pt: 'Intro to Model Context Protocol (MCP)',
        en: 'Intro to Model Context Protocol (MCP)',
      },
      issuer: 'Scrimba',
      year: 'Mar/2026',
      status: { pt: 'Certificado', en: 'Certified' },
      credentialId: 'B5DFK16PAN8X',
    },
    {
      name: {
        pt: 'Vibe Coding with Claude Code',
        en: 'Vibe Coding with Claude Code',
      },
      issuer: 'Scrimba',
      year: 'Mar/2026',
      status: { pt: 'Certificado', en: 'Certified' },
      credentialId: 'RNH2UVK145D8',
    },
    {
      name: {
        pt: 'Vibe Coding with Cursor AI',
        en: 'Vibe Coding with Cursor AI',
      },
      issuer: 'Scrimba',
      year: 'Mar/2026',
      status: { pt: 'Certificado', en: 'Certified' },
      credentialId: 'L4Q4H469IVAE',
    },
    {
      name: {
        pt: 'Vibe Coding with GitHub Copilot',
        en: 'Vibe Coding with GitHub Copilot',
      },
      issuer: 'Scrimba',
      year: 'Mar/2026',
      status: { pt: 'Certificado', en: 'Certified' },
      credentialId: 'YFMEDUR37IKO',
    },
    {
      name: {
        pt: 'Databricks Fundamentals Accreditation',
        en: 'Databricks Fundamentals Accreditation',
      },
      issuer: 'Databricks',
      year: 'Ago/2025',
      status: { pt: 'Certificado', en: 'Certified' },
    ...
    {
      name: {
        pt: 'Torne-se Especialista em Excel',
        en: 'Excel Specialist Certification',
      },
    ...
    {
      name: {
        pt: 'Excel: Macros e VBA para Iniciantes & Fórmulas Avançadas',
        en: 'Excel: VBA & Advanced Formulas',
      },
      issuer: 'LinkedIn Learning',
      year: 'Nov/2025',
      status: { pt: 'Certificado', en: 'Certified' },
    },
    {
      name: {
        pt: 'Curso de Excel',
        en: 'Excel Professional Training',
      },
      issuer: 'Microsoft',
      year: 'Ago/2025',
      status: { pt: 'Certificado', en: 'Certified' },
    ...
    {
      name: {
        pt: 'Pandas & Manipulação de Dados',
        en: 'Pandas & Data Wrangling',
      },
      issuer: 'Kaggle',
      year: 'Ago/2025',
      status: { pt: 'Certificado', en: 'Certified' },
    ...
    {
      name: {
        pt: 'Intro to Machine Learning',
        en: 'Intro to Machine Learning',
      },
      issuer: 'Kaggle',
      year: 'Jul/2025',
      status: { pt: 'Certificado', en: 'Certified' },
      credentialUrl: 'https://www.kaggle.com/learn/certification/flavianojr/intro-to-machine-learning',
    },
    {
      name: {
        pt: 'Gestão de Projetos e Fundamentos de Métodos Agile',
        en: 'Agile Project Management Foundations',
      },
      issuer: 'Santander Open Academy',
      year: 'Jul/2025',
      status: { pt: 'Certificado', en: 'Certified' },
      credentialId: 'OA-2025-0704001322753',
    },
    {
      name: {
        pt: 'Intro to SQL & Python',
        en: 'Intro to SQL & Python',
      },
      issuer: 'Kaggle',
      year: '2025',
      status: { pt: 'Certificado', en: 'Certified' },
    ...
    {
      name: {
        pt: 'EBAC Top Voices · Reconhecimento & Engajamento',
        en: 'EBAC Top Voices · Community Recognition',
      },
      issuer: 'EBAC',
      year: '2025',
    ...
    {
      name: {
        pt: 'Python para Data Science & Power BI Desktop',
        en: 'Python for Data Science & Power BI',
      },
      issuer: 'Alura',
      year: 'Abr/2024',
      status: { pt: 'Certificado', en: 'Certified' },
      credentialId: 'fbd569ba-678a-4148-97d0-cce35c4b7793',
    },
    {
      name: {
        pt: 'SQLite Online',
        en: 'SQLite Online & Relational DBs',
      },
      issuer: 'Alura',
      year: 'Jul/2024',
      status: { pt: 'Certificado', en: 'Certified' },
      credentialId: '98da5def-817e-463e-a7d3-e8707a1517ff',
    },
  ],
  skillsCloud: {
    pt: {
      label: 'Competências & Palavras-Chave',
      title: 'Tags e domínios de conhecimento prático.',
      tags: [
        'SQL Server',
        'T-SQL',
        'Power BI',
    ...
    en: {
      label: 'Competencies & Keywords',
      title: 'Tags and practical domains of expertise.',
      tags: [
        'SQL Server',
        'T-SQL',
        'Power BI',
